...
-   Accessing cloud-optimized geospatial data (COGS) via STAC (Spatial-Temporal Asset Catalogs) R
...
- There are currently petabytes of satellite imagery collections from satellite imagery missions like Landsat and Copernicus, as well as troves of national and global scale raster data we can access remotely in cloud-native geospatial format
- There are a number of other cloud-native geospatial formats that we don't have time to cover today which include:
  - Zarr
  - Flatgeobuff
  - GeoParquet
