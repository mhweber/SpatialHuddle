...
- Reading COGs in R can be done in a couple ways but using GDAL [virtual file system](https://gdal.org/user/virtual_file_systems.html)is a super quick and easy way to read in combined with `terra`
```{r}
#| output-location: slide
